#!/bin/bash -e
# Utility script to set CA root certificate contents as arguments for Edgegap deployment
# This works around Edgegap's 255-byte environment variable limitation
